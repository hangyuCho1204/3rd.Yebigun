...
<div class="orderlist" style="margin-left: 300px"  align="center">
  ...
  <div class="w3-center w3-padding-32">
    <ul class="w3-pagination">
      <li> <a class="w3-hover-black" href="/3rd.Yebigun/product/designList?selectPage=1">첫페이지</a></li>
      <c:if test="${selectpage > 1}" >
      <li> <a class="w3-hover-black" href="/3rd.Yebigun/product/designList?selectPage=${selectpage-1}">«</a></li>
      </c:if>  
      <c:forEach var="page" begin="1" step="1" end="${endpage}">
      <li> <a class="w3-hover-black" href="/3rd.Yebigun/product/designList?selectPage=${page}">${page}</a> </li>
      </c:forEach>
      <c:if test="${selectpage < endpage}" >
      <li> <a class="w3-hover-black" href="/3rd.Yebigun/product/designList?selectPage=${selectpage+1}">»</a></li>
      </c:if>
      <li><a class="w3-hover-black" href="/3rd.Yebigun/product/designList?selectPage=${endpage}">마지막페이지</a> </li>
    </ul>
  </div> 
